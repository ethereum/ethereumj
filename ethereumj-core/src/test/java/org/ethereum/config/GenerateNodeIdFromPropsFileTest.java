...
@NotThreadSafe
public class GenerateNodeIdFromPropsFileTest {
    ...
    public void testGenerateNodeIdFromPropsFileReadsExistingFile() throws Exception {
        ...
        new GenerateNodeIdFromPropsFile("database-test").getNodePrivateKey();
    ...
    public void testGenerateNodeIdFromPropsDoesntGenerateRandomWhenFileIsPresent() throws Exception {
        ...
        GenerateNodeIdFromPropsFile fileNodeIdGeneratorStrategy = new GenerateNodeIdFromPropsFile("database-test");
        fileNodeIdGeneratorStrategy.setFallbackGenerateNodeIdStrategy(randomNodeIdGeneratorStrategySpy);

        verifyZeroInteractions(randomNodeIdGeneratorStrategySpy);
    }

    @Test
    public void testGenerateNodeIdFromPropsGeneratesRandomWhenFileIsNotPresent() throws Exception {
        GenerateNodeIdRandomly randomNodeIdGeneratorStrategySpy = spy(new GenerateNodeIdRandomly("database-test"));
        GenerateNodeIdFromPropsFile fileNodeIdGeneratorStrategy = new GenerateNodeIdFromPropsFile("database-test");
        fileNodeIdGeneratorStrategy.setFallbackGenerateNodeIdStrategy(randomNodeIdGeneratorStrategySpy);
