...
public class LockBlockchainTest {
    ...
    private final static String BLOCK_RLP =
    ...
    public LockBlockchainTest() {
        ...
        SysPropConfig1.props.overrideParams("peer.discovery.enabled",
                                            "false",
                                            "peer.listen.port",
                                            "37777",
                                            "peer.privateKey",
        ...
        SysPropConfig1.testHandler =
                new Eth62(SysPropConfig1.props, blockchain, blockStoreDummy, new CompositeEthereumListener()) {
                    {
                        this.blockstore = blockStoreDummy;
