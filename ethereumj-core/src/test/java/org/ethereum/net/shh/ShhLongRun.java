...
public class ShhLongRun extends Thread {
    ...
    public void test() throws Exception {
        ...
        //        Node node = new Node
        // ("enode://52994910050f13cbd7848f02709f2f5ebccc363f13dafc4ec201e405e2f143ebc9c440935b3217073f6ec47f613220e0bc6b7b34274b7d2de125b82a2acd34ee" +
        //                "@whisper-1.ether.camp:30303");

        remoteJsonRpc = new URL("http://localhost:8545");
        Node node = new Node(
                "enode://6ed738b650ac2b771838506172447dc683b7e9dae7b91d699a48a0f94651b1a0d2e2ef01c6fffa22f762aaa553286047f0b0bb39f2e3a24b2a18fe1b9637dcbe" +
                        "@localhost:10003");
    ...
    public static class TestComponent extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                MessageMatcher remoteMatcherToFrom =
                        new MessageMatcher(remoteKey2, localKey2, Topic.createTopics("aaa"));
                ...
                while (true) {
                    {
                        WhisperMessage msg = new WhisperMessage().setPayload("local-" + cnt)
                                .setTopics(Topic.createTopics(localTopic));
                        remoteMatcherBroad.waitForMessage(msg);
                        whisper.send(msg.getPayload(), msg.getTopics());
                    }
                    {
                        WhisperMessage msg = new WhisperMessage().setPayload("remote-" + cnt)
                    ...
                    {
                        WhisperMessage msg = new WhisperMessage().setPayload("local-to-" + cnt)
                                .setTo(remoteKey1)
                    ...
                    {
                        WhisperMessage msg = new WhisperMessage().setPayload("local-to-from-" + cnt)
                                .setTo(remoteKey2)
                                .setFrom(localKey2)
                                .setTopics(Topic.createTopics("aaa"));
                    ...
                    {
                        WhisperMessage msg = new WhisperMessage().setPayload("remote-to-from-" + cnt)
                                .setTo(localKey2)
                                .setFrom(remoteKey2);
