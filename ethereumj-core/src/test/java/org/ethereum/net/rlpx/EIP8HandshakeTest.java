...
public class EIP8HandshakeTest {
    ...
    private ECKey.ECDSASignature signatureA = ECKey.ECDSASignature.fromComponents(decode(
            "299ca6acfd35e3d72d8ba3d1e2b60b5561d5af5218eb5bc182045769eb422691"),
    ...
    public void test1() throws InvalidCipherTextException {
        ...
        byte[] authMessageData =
                decode("01b304ab7578555167be8154d5cc456f567d5ba302662433674222360f08d5f1534499d3678b513b" +
    ...
    public void test2() throws InvalidCipherTextException {
        ...
        byte[] authMessageData =
                decode("01b8044c6c312173685d1edd268aa95e1d495474c6959bcdd10067ba4c9013df9e40ff45f5bfd6f7" +
    ...
    public void test3() throws InvalidCipherTextException {
        ...
        byte[] authResponseData =
                decode("01ea0451958701280a56482929d3b0757da8f7fbe5286784beead59d95089c217c9b917788989470" +
        ...
        assertArrayEquals(decode("2ea74ec5dae199227dff1af715362700e989d889d7a493cb0639691efb8e5f98"),
    ...
    public void test4() throws InvalidCipherTextException {
        ...
        byte[] authMessageData =
                decode("01f004076e58aae772bb101ab1a8e64e01ee96e64857ce82b1113817c6cdd52c09d26f7b90981cd7" +
