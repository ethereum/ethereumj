...
public class TransactionTest {
    ...
    @Test /* sign transaction  https://tools.ietf.org/html/rfc6979 */ public void test1()
    ...
    @Ignore
    @Test  /* achieve public key of the sender */ public void test2() throws Exception {
    ...
    @Ignore
    @Test  /* achieve public key of the sender nonce: 01 */ public void test3() throws Exception {
    ...
    public void testTransactionFromSignedRLP() throws Exception {
        ...
        assertEquals("eab47c1a49bf2fe5d40e01d313900e19ca485867d462fe06e139e3a536c6d4f4",
    ...
    public void testTransactionFromNew1() throws MissingPrivateKeyException {
        Transaction txNew =
                new Transaction(testNonce, testGasPrice, testGasLimit, testReceiveAddress, testValue, testData);
    ...
    public void encodeReceiptTest() {
        ...
        LogInfo logInfo1 =
                new LogInfo(Hex.decode("cd2a3d9f938e13cd947ec05abc7fe734df8dd826"), null, Hex.decode("a1a1a1"));
    ...
    public void constantCallConflictTest() throws Exception {
        ...
        */
        String json = "{ " + "    'test1' : { " + "        'env' : { " +
                "            'currentCoinbase' : '2adc25665018aa1fe0e6bc666dac8fc2697ff9ba', " +
                "            'currentDifficulty' : '0x0100', " + "            'currentGasLimit' : '0x0f4240', " +
                "            'currentNumber' : '0x00', " + "            'currentTimestamp' : '0x01', " +
                "            'previousHash' : '5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6' " +
                "        }, " + "        'logs' : [ " + "        ], " + "        'out' : '0x', " +
                "        'post' : { " + "            '095e7baea6a6c7c4c2dfeb977efac326af552d87' : { " +
                "                'balance' : '0x0de0b6b3a76586a0', " +
                "                'code' : " +
                "'0x606060405260e060020a600035046360fe47b1811460245780636d4ce63c14602e575b005b6004356000556022565b6000546060908152602090f3', " +
                "                'nonce' : '0x00', " + "                'storage' : { " +
                "                    '0x00' : '0x0400' " + "                } " + "            }, " +
                "            '2adc25665018aa1fe0e6bc666dac8fc2697ff9ba' : { " +
                "                'balance' : '0x67c3', " + "                'code' : '0x', " +
                "                'nonce' : '0x00', " + "                'storage' : { " + "                } " +
                "            }, " + "            'a94f5374fce5edbc8e2a8697c15331677e6ebf0b' : { " +
                "                'balance' : '0x0DE0B6B3A762119D', " + "                'code' : '0x', " +
                "                'nonce' : '0x01', " + "                'storage' : { " + "                } " +
                "            } " + "        }, " +
                "        'postStateRoot' : '17454a767e5f04461256f3812ffca930443c04a47d05ce3f38940c4a14b8c479', " +
                "        'pre' : { " + "            '095e7baea6a6c7c4c2dfeb977efac326af552d87' : { " +
        ...
        List<String> res = new StateTestRunner(stateTestSuite.getTestCases().get("test1")) {
            ...
            protected ProgramResult executeTransaction(Transaction tx) {
...

                {
                    ...
                    Transaction txConst = CallTransaction.createCallTransaction(0,
                                                                                0,
                                                                                100000000000000L,
                    ...
                    TransactionExecutor executor = new TransactionExecutor(txConst,
                                                                           bestBlock.getCoinbase(),
                                                                           track,
                                                                           new BlockStoreDummy(),
                                                                           invokeFactory,
                                                                           bestBlock).setLocalCall(true);
    ...
    public void homesteadContractCreationTest() throws Exception {
        ...
        */
        ...
        String json = "{ " + "    'test1' : { " + "        'env' : { " +
                "            'currentCoinbase' : '2adc25665018aa1fe0e6bc666dac8fc2697ff9ba', " +
                "            'currentDifficulty' : '0x0100', " + "            'currentGasLimit' : '0x0f4240', " +
                "            'currentNumber' : '0x01', " + "            'currentTimestamp' : '0x01', " +
                "            'previousHash' : '5e20a0453cecd065ea59c37ac63e079ee08998b6045136a8ce6635c7912ec0b6' " +
                "        }, " + "        'logs' : [ " + "        ], " + "        'out' : '0x', " +
                "        'post' : { " + "            '2adc25665018aa1fe0e6bc666dac8fc2697ff9ba' : { " +
                "                'balance' : '" + aBitLowGas + "', " + "                'code' : '0x', " +
                "                'nonce' : '0x00', " + "                'storage' : { " + "                } " +
                "            }," + "            'a94f5374fce5edbc8e2a8697c15331677e6ebf0b' : { " +
                "                'balance' : '" + senderPostBalance + "', " + "                'code' : '0x', " +
                "                'nonce' : '0x01', " + "                'storage' : { " + "                } " +
                "            } " + "        }, " +
                "        'postStateRoot' : '17454a767e5f04461256f3812ffca930443c04a47d05ce3f38940c4a14b8c479', " +
                ...
                "            } " + "        }, " + "        'transaction' : { " +
                "            'data' : " +
                "'0x6060604052610100600060005055603b8060196000396000f3606060405260e060020a600035046360fe47b1811460245780636d4ce63c14602e575b005b6004356000556022565b6000546060908152602090f3', " +
                "            'gasLimit' : '" + aBitLowGas + "', " + "            'gasPrice' : '0x01', " +
                "            'nonce' : '0x00', " +
                "            'secretKey' : '45a915e4d060149eb4365960e6a7a45f334393093061116b197e3240065ff2d8', " +
                "            'to' : '', " + "            'value' : '0x0' " + "        } " + "    } " + "}";
    ...
    public void multiSuicideTest() throws IOException, InterruptedException {
        String contract = "pragma solidity ^0.4.3;" + "contract PsychoKiller {" + "    function () payable {}" +
                "    function homicide() {" + "        suicide(msg.sender);" + "    }" +
                "    function multipleHomocide() {" + "        PsychoKiller k  = this;" + "        k.homicide();" +
                "        k.homicide();" + "        k.homicide();" + "        k.homicide();" + "    }" + "}";
        SolidityCompiler.Result res = SolidityCompiler.compile(contract.getBytes(),
                                                               true,
        ...
        if (cres.contracts.get("PsychoKiller") != null) {
            Transaction tx =
                    createTx(blockchain, sender, new byte[0], Hex.decode(cres.contracts.get("PsychoKiller").bin));
    ...
    public void receiptErrorTest() throws Exception {
...

        {
            ...
            TransactionReceipt receipt = new TransactionReceipt(Hex.decode(
                    ""));
        ...
        {
            Transaction tx = new Transaction(ByteUtil.intToBytesNoLeadZeroes(100500),
        ...
        {
            String contract = "contract GasConsumer {" + "    function GasConsumer() {" + "        int i = 0;" +
                    "        while(true) sha3(i++);" + "    }" + "}";
            SolidityCompiler.Result res = SolidityCompiler.compile(contract.getBytes(),
                                                                   true,
                                                                   SolidityCompiler.Options.ABI,
            ...
            CompilationResult cres = CompilationResult.parse(res.output);
            Transaction tx =
                    createTx(blockchain, sender, new byte[0], Hex.decode(cres.contracts.get("GasConsumer").bin), 0);
            TransactionReceipt receipt = executeTransaction(blockchain, tx).getReceipt();
            receipt = new TransactionReceipt(receipt.getEncoded());
    ...
    public void afterEIP158Test() throws Exception {
        ...
        BigInteger signatureR =
                new BigInteger("18515461264373351373200002665853028612451056578545711640558177340181847433846");
        BigInteger signatureS =
                new BigInteger("46948507304638947509940763649030358759909902576025900602547168820602576006531");
        String signedTxRlp =
    ...
    public void etcChainIdTest() {
        Transaction tx = new Transaction(Hex.decode(
                "f871830617428504a817c80083015f90940123286bd94beecd40905321f5c3202c7628d685880ecab7b2bae2c27080819ea021355678b1aa704f6ad4706fb8647f5125beadd1d84c6f9cf37dda1b62f24b1aa06b4a64fd29bb6e54a2c5107e8be42ac039a8ffb631e16e7bcbd15cdfc0015ee2"));
    ...
    public void longChainIdTest() {
        Transaction tx = new Transaction(Hex.decode(
                ""));
        Integer chainId = tx.getChainId();
        assert 16123 == chainId;

        Transaction tx1 = Transaction.create("3535353535353535353535353535353535353535",
                                             new BigInteger("1000000000000000000"),
                                             new BigInteger("9"),
                                             new BigInteger("20000000000"),
                                             new BigInteger("21000"),
