...
public class BlockHeaderValidator {
    ...
    public static ArrayList<String> valid(BlockHeader orig, BlockHeader valid) {
        ...
        if (!toHexString(orig.getParentHash()).equals(toHexString(valid.getParentHash()))) {

            String output = String.format("wrong block.parentHash: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getUnclesHash()).equals(toHexString(valid.getUnclesHash()))) {
            ...
            String output = String.format("wrong block.unclesHash: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getCoinbase()).equals(toHexString(valid.getCoinbase()))) {

            String output = String.format("wrong block.coinbase: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getStateRoot()).equals(toHexString(valid.getStateRoot()))) {
            ...
            String output = String.format("wrong block.stateRoot: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getTxTrieRoot()).equals(toHexString(valid.getTxTrieRoot()))) {
            ...
            String output = String.format("wrong block.txTrieRoot: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getReceiptsRoot()).equals(toHexString(valid.getReceiptsRoot()))) {
            ...
            String output = String.format("wrong block.receiptsRoot: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getLogsBloom()).equals(toHexString(valid.getLogsBloom()))) {
            ...
            String output = String.format("wrong block.logsBloom: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getDifficulty()).equals(toHexString(valid.getDifficulty()))) {

            String output = String.format("wrong block.difficulty: \n expected: %s \n got: %s",
        ...
        if (orig.getTimestamp() != valid.getTimestamp()) {
            ...
            String output = String.format("wrong block.timestamp: \n expected: %d \n got: %d",
                                          valid.getTimestamp(),
                                          orig.getTimestamp());
        ...
        if (orig.getNumber() != valid.getNumber()) {
            ...
            String output = String.format("wrong block.number: \n expected: %d \n got: %d",
                                          valid.getNumber(),
                                          orig.getNumber());
        ...
        if (!new BigInteger(1, orig.getGasLimit()).equals(new BigInteger(1, valid.getGasLimit()))) {
            ...
            String output = String.format("wrong block.gasLimit: \n expected: %d \n got: %d",
        ...
        if (orig.getGasUsed() != valid.getGasUsed()) {
            ...
            String output = String.format("wrong block.gasUsed: \n expected: %d \n got: %d",
                                          valid.getGasUsed(),
                                          orig.getGasUsed());
        ...
        if (!toHexString(orig.getMixHash()).equals(toHexString(valid.getMixHash()))) {

            String output = String.format("wrong block.mixHash: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getExtraData()).equals(toHexString(valid.getExtraData()))) {
            ...
            String output = String.format("wrong block.extraData: \n expected: %s \n got: %s",
        ...
        if (!toHexString(orig.getNonce()).equals(toHexString(valid.getNonce()))) {

            String output = String.format("wrong block.nonce: \n expected: %s \n got: %s",
