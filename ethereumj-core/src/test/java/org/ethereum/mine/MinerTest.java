...
//        System.out.println("======= Sending forked block without parent...");
    ...
    public void blockTest1() {
        ...
        for (String s : rlp.split("\\|")) {
            IBlockHeader IBlockHeader = BlockHeader.createBlockHeader(Hex.decode(s));
            System.out.println(Hex.toHexString(IBlockHeader.getHash()).substring(0, 6));
            System.out.println(IBlockHeader);
        }
    }
