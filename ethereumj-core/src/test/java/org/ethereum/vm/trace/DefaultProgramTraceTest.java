...
public class DefaultProgramTraceTest {
    ...
    /**
     * contract: {@link DefaultProgramTrace#result(byte[])} method converts the byte
     * array to a HEX string and set it in the "result" instance variable
     * 
     */
    @Test
    ...
    /**
     * contract: {@link DefaultProgramTrace#result(byte[])} method sets the result
     * to an empty string if the byte array is null
     * 
     * 
     */
    @Test
    ...
    /**
     * contract: {@link DefaultProgramTrace#error(Exception)} method sets the
     * instance variable "error" to "ExceptionClass: Message"
     * 
     */
    @Test
    ...
    /**
     * contract: {@link DefaultProgramTrace#error(Exception)} method sets the
     * instance variable "error" to empty string if the exception passed was null
     * 
     */
    @Test
    ...
    /**
     * contract: {@link DefaultProgramTrace#merge(ProgramTrace)} method the items in
     * "ops" list of the send DefaultProgramTrace object to the "ops" list of this
     * object
     * 
     */
    @Test
    ...
    /**
     * contract: {@link DefaultProgramTrace#asJsonString(boolean)} method converts
     * the DefaultProgramTrace to a json string
     * 
     */
    @Test
    ...
    /**
     * contract: {@link DefaultProgramTrace#toString()} method return a formatted
     * json string
     * 
     */
    @Test
