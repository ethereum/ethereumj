...
public class VMTest {
    ...
    public void testSDIV_1() {
        ...
        program = new Program(Hex.decode(
                "6103E87FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC1805" + ""), invoke);
    ...
    public void testRETURN_3() {
        ...
        VM vm = new VM();
        program = new Program(Hex.decode(
                "7FA0B0C0D0E0F0A1B1C1D1E1F1A2B2C2D2E2F2A3B3C3D3E3F3A4B4C4D4E4F4A1B160005260206000F3"), invoke);
    ...
    public void testRETURN_4() {
        ...
        VM vm = new VM();
        program = new Program(Hex.decode(
                "7FA0B0C0D0E0F0A1B1C1D1E1F1A2B2C2D2E2F2A3B3C3D3E3F3A4B4C4D4E4F4A1B160005260206010F3"), invoke);
    ...
    public void testCODECOPY_1() {
        ...
        VM vm = new VM();
        program = new Program(Hex.decode("60036007600039123456"), invoke);
    ...
    public void testEXTCODECOPY_1() {
        ...
        VM vm = new VM();
        program = new Program(Hex.decode("60036007600073471FD3AD3E9EEADEEC4608B92D16CE6B500704CC3C123456"), invoke);
    ...
    public void testEXTCODECOPY_5() {
        VM vm = new VM();
        program = new Program(Hex.decode("605E600773471FD3AD3E9EEADEEC4608B92D16CE6B500704CC3C"), invoke);
        try {
            vm.step(program);
            vm.step(program);
            vm.step(program);
