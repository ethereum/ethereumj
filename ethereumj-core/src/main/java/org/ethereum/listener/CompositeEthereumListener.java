...
public class CompositeEthereumListener implements EthereumListener {
  ...
  protected List<EthereumListener> inlineListeners = new CopyOnWriteArrayList<>();
  ...
  public void addInlineListener(EthereumListener listener) {
    inlineListeners.add(listener);
  }

  public void removeInlineListener(EthereumListener listener) {
    inlineListeners.remove(listener);
  }
  ...
  public void trace(final String output) {
    ...
    for (EthereumListener listener : inlineListeners) {
      listener.trace(output);
    }
  }
