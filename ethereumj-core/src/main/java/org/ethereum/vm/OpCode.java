...
public enum OpCode {
     ...
     */
    ADD(0x01, 2, Tier.VeryLowTier),
    /**
     * (0x02) Multiplication operation
     */
    MUL(0x02, 2, Tier.VeryLowTier),
    /**
     * (0x03) Subtraction operations
     */
    SUB(0x03, 2 , Tier.VeryLowTier),
    /**
     * (0x04) Integer division operation
     */
    DIV(0x04, 2, Tier.VeryLowTier),
    /**
     * (0x05) Signed integer division operation
     */
    SDIV(0x05, 2, Tier.VeryLowTier),
    /**
     ...
     */
    SMOD(0x07, 2, Tier.VeryLowTier),
    /**
     * (0x08) Addition combined with modulo
     * remainder operation
     */
    ADDMOD(0x08, 3, Tier.VeryLowTier),
    /**
     * (0x09) Multiplication combined with modulo
     * remainder operation
     */
    MULMOD(0x09, 3, Tier.VeryLowTier),
    /**
     * (0x0a) Exponential operation
     */
    EXP(0x0a, 2, Tier.VeryLowTier),
    /**
     * (0x0b) Extend length of signed integer
     */
    SIGNEXTEND(0x0b, 2, Tier.VeryLowTier),
     ...
     */
    LT(0X10, 2, Tier.VeryLowTier),
    /**
     * (0x11) Greater-than comparison
     */
    GT(0X11, 2, Tier.VeryLowTier),
    /**
     * (0x12) Signed less-than comparison
     */
    SLT(0X12, 2, Tier.VeryLowTier),
    /**
     * (0x13) Signed greater-than comparison
     */
    SGT(0X13, 2, Tier.VeryLowTier),
    /**
     * (0x14) Equality comparison
     */
    EQ(0X14, 2, Tier.VeryLowTier),
    /**
     * (0x15) Negation operation
     */
    ISZERO(0x15, 1, Tier.VeryLowTier),
    /**
     * (0x16) Bitwise AND operation
     */
    AND(0x16, 2, Tier.VeryLowTier),
    /**
     * (0x17) Bitwise OR operation
     */
    OR(0x17, 2, Tier.VeryLowTier),
    /**
     * (0x18) Bitwise XOR operation
     */
    XOR(0x18, 2, Tier.VeryLowTier),
    /**
     * (0x19) Bitwise NOT operationr
     */
    NOT(0x19, 1, Tier.VeryLowTier),
    /**
     * (0x1a) Retrieve single byte from word
     */
    BYTE(0x1a, 2, Tier.VeryLowTier),
     ...
     * executing account
     */
    ADDRESS(0x30, 0, Tier.VeryLowTier),
    /**
     * (0x31) Get balance of the given account
     */
    BALANCE(0x31, 1, Tier.VeryLowTier),
    /**
     ...
     * complete block
     */
    BLOCKHASH(0x40, 1, Tier.VeryLowTier),
    /**
     * (0x41) Get the block’s coinbase address
     */
    COINBASE(0x41, 0, Tier.VeryLowTier),
    /**
     * (x042) Get the block’s timestamp
     */
    TIMESTAMP(0x42, 0, Tier.VeryLowTier),
    /**
     * (0x43) Get the block’s number
     */
    NUMBER(0x43, 0, Tier.VeryLowTier),
    /**
     * (0x44) Get the block’s difficulty
     */
    DIFFICULTY(0x44, 0, Tier.VeryLowTier),
    /**
     * (0x45) Get the block’s gas limit
     */
    GASLIMIT(0x45, 0, Tier.VeryLowTier),
     ...
     */
    MLOAD(0x51, 1, Tier.VeryLowTier),
    /**
     * (0x52) Save word to memory
     */
    MSTORE(0x52, 2, Tier.VeryLowTier ),
    /**
     * (0x53) Save byte to memory
     */
    MSTORE8(0x53, 2, Tier.VeryLowTier),
    /**
     * (0x54) Load word from storage
     */
    SLOAD(0x54, 1, Tier.VeryLowTier),
    /**
     * (0x55) Save word to storage
     */
    SSTORE(0x55, 2, Tier.VeryLowTier),
    /**
     * (0x56) Alter the program counter
     */
    JUMP(0x56, 1, Tier.VeryLowTier),
    /**
     * (0x57) Conditionally alter the program
     * counter
     */
    JUMPI(0x57, 2, Tier.VeryLowTier),
    /**
     ...
     */
    MSIZE(0x59, 0, Tier.VeryLowTier),
    /**
     * (0x5a) Get the amount of available gas
     */
    GAS(0x5a, 0, Tier.VeryLowTier),
    /**
     * (0x5b)
     */
    JUMPDEST(0x5b, 0, Tier.VeryLowTier),
     ...
     */
    CREATE(0xf0, 3, Tier.VeryLowTier),   //       [in_size] [in_offs] [gas_val] CREATE
    /**
     * (cxf1) Message-call into an account
     */
    CALL(0xf1, 7, Tier.VeryLowTier),     //       [out_data_size] [out_data_start] [in_data_size] [in_data_start] [value] [to_addr]
    // [gas] CALL
    /**
     * (0xf2) Calls self, but grabbing the code from the
     * TO argument instead of from one's own address
     */
    CALLCODE(0xf2, 7, Tier.VeryLowTier),
    /**
     * (0xf3) Halt execution returning output data
     */
    RETURN(0xf3, 2, Tier.VeryLowTier),
    /**
     * (0xff) Halt execution and register account for
     * later deletion
     */
    SUICIDE(0xff, 1, Tier.VeryLowTier);
