...
public class DefaultMemory implements Memory {
     ...
     * 
     * @see
     * org.ethereum.vm.program.Memory#setProgramListener(org.ethereum.vm.program.
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#read(int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#write(int, byte[], int, boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#extendAndWrite(int, int, byte[])
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#extend(int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#readWord(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#readByte(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#toString()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#size()
     */
    @Override
    public int size() {
	return softSize;
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#internalSize()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.ethereum.vm.program.Memory#getChunks()
     */
    @Override
