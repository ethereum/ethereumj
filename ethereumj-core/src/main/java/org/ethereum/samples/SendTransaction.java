...
public class SendTransaction extends BasicSample {
    ...
    private TransactionReceipt sendTxAndWait(byte[] receiveAddress, byte[] data) throws InterruptedException {
        ...
        Transaction tx = new Transaction(ByteUtil.bigIntegerToBytes(nonce),
                                         ...
                                         receiveAddress,
                                         ByteUtil.bigIntegerToBytes(BigInteger.valueOf(1)),
                                         // 1_000_000_000 gwei, 1_000_000_000_000L szabo, 1_000_000_000_000_000L
                                         // finney, 1_000_000_000_000_000_000L ether
                                         data,
