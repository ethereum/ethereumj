...
public class CasperValidatorService {
    ...
    private void logCasperInfo() {
        ...
        String logStr = String.format(
                ...
                curEpoch,
                curVotesScaled.divide(BigDecimal.valueOf(10).pow(18), MathContext.DECIMAL32),
                new BigDecimal(curDeposits).divide(BigDecimal.valueOf(10).pow(18), MathContext.DECIMAL32),
                curVotesPct,
                prevVotesScaled.divide(BigDecimal.valueOf(10).pow(18), MathContext.DECIMAL32),
                new BigDecimal(prevDeposits).divide(BigDecimal.valueOf(10).pow(18), MathContext.DECIMAL32),
                prevVotesPct,
                lastFinalizedEpoch,
                lastJustifiedEpoch,
                expectedSourceEpoch,
