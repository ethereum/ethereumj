...
/**
 * Default implementation of {@link ValidatorRepository}
 *
...
public class ValidatorRepositoryImpl implements ValidatorRepository {
    ...
    @Autowired
    public ValidatorRepositoryImpl(BlockStore blockStore, TransactionStore txStore, DepositContract depositContract) {
