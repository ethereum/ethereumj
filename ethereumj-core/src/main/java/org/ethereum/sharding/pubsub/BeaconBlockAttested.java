...
/**
 * When new {@link AttestationRecord} received
 */
public class BeaconBlockAttested extends Event<BeaconBlockAttested.Data> {
    ...
    public BeaconBlockAttested(AttestationRecord attestationRecord) {
