...
public class ECIESCoder {
     ...
     * <p>
     * DL_KeyAgreementAlgorithm:        DL_KeyAgreementAlgorithm_DH<struct ECPPoint,struct EnumToType<enum
     * CofactorMultiplicationOption,0> >
    ...
    public static byte[] decryptSimple(BigInteger privKey, byte[] cipher)
        ...
        iesEngine.init(new ECPrivateKeyParameters(privKey, CURVE),
                       parametersWithIV,
    ...
    public static byte[] encryptSimple(ECPoint pub, byte[] plaintext) throws IOException, InvalidCipherTextException {
        ...
        //            ECKey priv = ECKey.fromPrivate(Hex.decode
