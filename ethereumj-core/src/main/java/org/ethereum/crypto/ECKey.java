...
public class ECKey implements Serializable {
    ...
    public ECKey(Provider provider, SecureRandom secureRandom) {
        ...
        if (pubKey instanceof BCECPublicKey) {
            ...
            throw new AssertionError(
                    "Expected Provider " + provider.getName() + " to produce a subtype of ECPublicKey, found " +
                            pubKey.getClass());
        }
    }
    ...
    public ECKey decompress() {
        if (!pub.isCompressed()) { return this; } else {
    ...
    public static class ECDSASignature {
        ...
        public static ECDSASignature decodeFromDER(byte[] bytes) {
            ...
            try {
                ...
                // OpenSSL deviates from the DER spec by interpreting these values as unsigned, though they should
                // not be
                ...
                if (decoder != null) { try { decoder.close(); } catch (IOException x) {} }
            }
        }
        ...
        public byte[] toByteArray() {
            ...
            return ByteUtil.merge(ByteUtil.bigIntegerToBytes(this.r),
